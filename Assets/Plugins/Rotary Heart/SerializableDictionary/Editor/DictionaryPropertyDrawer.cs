...
namespace RotaryHeart.Lib.SerializableDictionary
{
    ...
    public class DictionaryPropertyDrawer : PropertyDrawer
    {
        ...
        /// <param name="index">Reactive index on the array</param>
        ...
        /// </summary>
        /// <param name="prop">Reactive to check</param>
        ...
        /// </summary>
        /// <param name="prop">Reactive to modify</param>
        ...
        /// </summary>
        /// <param name="prop">Reactive</param>
