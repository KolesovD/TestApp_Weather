...
namespace RotaryHeart.Lib.SerializableDictionary
{
    ...
    [System.Serializable]
    public class SerializableDictionaryBase<TKey, TValue> : DrawableDictionary, IDictionary<TKey, TValue>, IReadOnlyDictionary<TKey, TValue>, UnityEngine.ISerializationCallbackReceiver
    {
        ...
        void ISerializationCallbackReceiver.OnBeforeSerialize()
        {
            ...
            else
            {
                ...
                while (e.MoveNext())
                {
                    //SetItemCount the respective data from the dictionary
